<x-layout>
    <div class="bg-white mx-auto p-8 rounded-lg shadow-md w-full md:max-w-3xl">
        ...
        <form method="POST" action="/jobs" enctype="multipart/form-data">
            ...
            <x-inputs.text-area cols="30" rows="7" id='description' name='description' label='Job Description' placeholder='We are seeking a skilled and motivated Software Developer to join our growing development team...' />
            ...
            <x-inputs.select id='job_type' name='job_type' label='Job Type' value="{{old('job_type')}}" :options="[
                'Full-Time' => 'Full-Time', 'Part-Time' => 'Part-Time', 'Contract' => 'Contract', 'Temporary' => 'Temporary', 'Internship' => 'Internship', 'Volunteer' => 'Volunteer', 'On-Call' => 'On-Call']" />
