        ...
        <section class="md:col-span-3">
            ...
            <div class="container mx-auto p-4">
                ...
                <div x-data="{ open: false }">
                    <button @click="open = true" class="block w-full text-center px-5 py-2.5 shadow-sm rounded border text-base font-medium cursor-pointer text-indigo-700 bg-indigo-100 hover:bg-indigo-200">Apply Now</button>
                    ...
                    <div x-cloak x-show="open" class="fixed inset-0 flex items-center justify-center bg-gray-900/50">
                        <div @click.away="open=false" class="bg-white p-6 rounded-lg shadow-md w-full max-w-md">
                            ...
                            <form method="POST" action="{{route('application.store', $job->id  )}}" enctype="multipart/form-data">
                                ...
                                <x-inputs.text name="contact_email" id="contact_email" label="Contact Email" :required="true"/>
                                ...
                                <button type="submit" class="bg-blue-500 hover:big-blue-600 text-white px-4 py-2 rounded-md">Submit Application</button>
                                <button @click="open=false" class="bg-gray-500 hover:big-gray-600 text-black px-4 py-2 rounded-md">Cancel</button>
                            </form>
                        </div>
                    </div>
                </div>
